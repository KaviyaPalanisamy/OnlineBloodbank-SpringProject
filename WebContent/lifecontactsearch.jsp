...
<div style="background-image: url('image/2.jpg');">
		 ...
		 <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			  ...
			  <div class="col-lg-12 search-split">
					<h4 style="color: #ff6;"> Find a Life Saver</h4>					
					 <form role="form" method="get" name="LifeSaverFilterForm"  id="LifeSaverFilterForm"  action="LifeSaverSearchList.do" enctype="multipart/form-data">					
  ...
  <div class="col-sm-12 col-md-12">					
									    ...
									    <c:forEach var="LifeSaver" items="${list}">
										<h2 align="center">Life Savers List</h2>
									  <table  class="table table-class"  cellpadding="5">								
										<tr style="background:rgba(0, 0, 0, 0.66);">
											...
											<th scope="col">EmailID</th>
											   ...
											   <tr>
												<td ><c:out value="${LifeSaver.name}" /></td>
												<td ><c:out value="${LifeSaver.gender}" /></td>
												<td ><c:out value="${LifeSaver.age}" /></td> 
												<td ><c:out value="${LifeSaver.bloodGroup}" /></td> 
												<td ><c:out value="${LifeSaver.phoneNumber}" /></td>
												<td ><c:out value="${LifeSaver.emailId}" /></td>
										...
										<div>
									<h2 align="center">	No Life Savers found </h2>
