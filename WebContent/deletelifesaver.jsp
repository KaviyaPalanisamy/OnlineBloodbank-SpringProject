					...
					<div class="col-sm-12 col-md-12">
						...
						<div class="row">
							<div class="col-sm-12 col-md-12">
								...
								<h2>Delete Life Saver</h2>
							</div>
							<div class="clearfix"></div>
							<br>
						</div>
						<form role="form"  class="form-horizontal" method="GET" action="deletelifesaving.do" name="lifesaverregisterForm"  id="lifesaverregisterForm"  enctype="multipart/form-data">	
...
<input type="text" name="status" value="Active" style="display: none;">
									...
									<div class="form-group">
										<label class="col-sm-5 control-label">Life Saver ID <span
											style="color: #d42e2e;">*</span></label>
										<div class="col-sm-7">
											<input type="text" placeholder="Enter Life Saver ID" value=""
												class="form-control" required autocomplete="off"
												ID="lifeSaversId" name="lifeSaversId">
										</div>
									</div>
							...
							<br>
									...
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<button type="submit" class="btn btn-primary to_be_register" >Delete</button>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
